...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMessagesForUser(int userId, [FromQuery]MessageParams messageParams)
        {
            ...
            var messages = mapper.Map<IEnumerable<MessageToReturmDto>>(messagesFromRepo);
        ...
        public async Task<IActionResult> GetMessageThread(int userId, int recipientId)
        {
            ...
            var messageThread = mapper.Map<IEnumerable<MessageToReturmDto>>(messagesFromRepo);
        ...
        public async Task<IActionResult> CreateMessage(int userId, MessageForCreationDto messageForCreationDto)
        {
            ...
            {
                message.Sender = await repo.GetUser(message.SenderId);
                var messageToReturm = mapper.Map<MessageToReturmDto>(message);
                return CreatedAtRoute("GetMessage", new { id = message.Id }, messageToReturm);
            }
